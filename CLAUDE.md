...
TheTabNinja2.0/
├── css/
│   └── styles.css              # External CSS with dark mode, responsive design
├── js/
│   ├── bm.js                   # Main new tab page logic
│   ├── popup.js                # Extension popup logic
│   └── background.js           # Service worker (sync, tabs, favicons)
├── images/
│   ├── icons/
│   │   ├── light-128.png       # Extension icon (light theme)
│   │   ├── dark-128.png        # Extension icon (dark theme)
│   │   ├── logo.png            # Project logo
│   │   ├── default-icon.png    # Default bookmark favicon
│   │   ├── default-icon.ico    # Default bookmark favicon (ICO)
│   │   ├── favicon.ico         # Extension favicon
│   │   └── 128p.png            # 128px icon variant
│   └── wallpapers/
│       ├── wp_none.png         # "No wallpaper" thumbnail
│       ├── wp_img01-16.png     # Wallpaper thumbnails
│       └── large_wp_img01-16.png # Full-size wallpapers
├── bm.html                     # Main new tab page (root)
├── popup.html                  # Extension popup (root)
├── tabninja_help.html          # User guide (root)
├── github-setup-guide.html     # GitHub PAT setup guide (root)
├── manifest.json               # Chrome extension manifest v3
└── CLAUDE.md, README.md, etc.
```

- `manifest.json` - Chrome extension manifest (v3, version 1.14)
- `bm.html` / `js/bm.js` - Main new tab page interface and logic
- `popup.html` / `js/popup.js` - Extension popup for saving current tab
- `js/background.js` - Service worker handling GitHub sync, tab management, favicon fetching
- `css/styles.css` - External CSS file with modern UI styling, dark mode support, and responsive design
...
4. CSS changes are in `css/styles.css`, JS logic in `js/` directory
...
#### Collection Management (`js/bm.js`)
...
#### Favicon Error Handling (`js/bm.js`)
...
#### Background Management (`js/bm.js`)
...
#### Enhanced Data Management (`js/bm.js`)
...
#### Automatic Backup System (`js/background.js` + `bm.js`)
...
3. Add UI components in `bm.html` and corresponding logic in `js/bm.js`
4. Update `css/styles.css` for any styling changes
